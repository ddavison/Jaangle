...
#define HID_SEARCH_STAT_MSG                     0x1007E
#define HID_SEARCH_STAT_RECORDS                 0x1007F
#define HID_SEARCH_STAT_TIME                    0x10080
#define HID_EXIT                                0x1040A
#define HID_ADD                                 0x1041B
#define HID_UPDATE                              0x1041C
#define HID_PLAYER_PLAY                         0x18008
#define HID_PLAYER_ENQUEUE                      0x18009
#define HID_FRM_FIND                            0x1800A
#define HID_FRM_OPTIONS                         0x1800C
#define HID_FRM_COLLECTIONS                     0x1800E
#define HID_FRM_ABOUT                           0x1800F
#define HID_FRM_HISTORY                         0x18010
#define HID_FRM_COLLECTION                      0x18011
#define HID_TBPREVIOUS                          0x18013
#define HID_TBPLAY                              0x18014
#define HID_TBPAUSE                             0x18015
#define HID_TBSTOP                              0x18016
#define HID_TBNEXT                              0x18017
#define HID_ADD_FOLDER                          0x18018
#define HID_ADD_MEDIA                           0x1801A
#define HID_ADDCOLLECTION                       0x1801B
#define HID_REFRESH_BACKGROUND                  0x1801F
#define HID_POPUP_FILEOPERATIONS                0x18023
#define HID_FILEOPERATIONS_COPY                 0x18024
#define HID_FILEOPERATIONS_MOVETO               0x18025
#define HID_FILEOPERATIONS_COPYPATH             0x18026
#define HID_FILEOPERATIONS_DELETE               0x18027
#define HID_POPUP_NAMETOTAGS                    0x18029
#define HID_POPUP_PROPERTIES32810               0x1802A
#define HID_RATING_EXCELLENT                    0x1802C
#define HID_RATING_VERYGOOD                     0x1802D
#define HID_RATING_NICE                         0x1802E
#define HID_RATING_NEUTRAL                      0x1802F
#define HID_RATING_BAD                          0x18030
#define HID_BUTTON32852                         0x18054
#define HID_MAINLISTNORMAL_DLLYRICS             0x18058
#define HID_RATINGS_OUTSTANDING                 0x18059
#define HID_RATINGS_EXCELLENT                   0x1805A
#define HID_RATINGS_NICE                        0x1805B
#define HID_RATINGS_OK                          0x1805C
#define HID_RATINGS_BAD                         0x1805D
#define HID_RATINGS_5                           0x1805E
#define HID_RATINGS_4                           0x1805F
#define HID_RATINGS_3                           0x18060
#define HID_RATINGS_2                           0x18061
#define HID_RATINGS_1                           0x18062
#define HID_MAINLISTNORMAL_RATING5              0x18063
#define HID_MAINLISTNORMAL_RATING1              0x18064
#define HID_MAINLISTNORMAL_RATING2              0x18065
#define HID_MAINLISTNORMAL_RATING3              0x18066
#define HID_MAINLISTNORMAL_RATING4              0x18067
#define HID_MAINLISTNORMAL_FIL_VID              0x18073
#define HID_MAINLISTNORMAL_PL_SHUFFLE           0x18073
#define HID_MAINLISTNORMAL_VISUALIZATIONS_DOCKED	0x18077
#define HID_MAINLISTNORMAL_OPTIONS              0x1807C
#define HID_MAINLISTNORMAL_EXITAPP              0x1807D
 
// Prompts (IDP_*) 
 
// Resources (IDR_*) 
#define HIDR_MAINFRAME                          0x20032
#define HIDR_MAINMENU                           0x20081
#define HIDR_MAIN_TOOLBAR                       0x20082
#define HIDR_DEFAULTEXPORTSTYLE                 0x2016E
#define HIDR_DEFAULTCOLORS                      0x201BC
#define HIDR_PROGRESSANI                        0x201C4
#define HIDR_ALBUM                              0x201F5
#define HIDR_PNG_ARTIST                         0x20202
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_TEENSPIRIT_DIALOG                  0x20066
#define HIDD_STATUSBAR                          0x20067
#define HIDD_PPLATESTADDITIONS                  0x20068
#define HIDD_PROPPAGE_MEDIUM                    0x2006A
#define HIDD_PPSIMPLESEARCH                     0x2006A
#define HIDD_IMAGEPREVIEWDLG                    0x20098
#define HIDD_COLLECTIONS                        0x200A3
#define HIDD_SEARCH                             0x200AC
#define HIDD_HISTORY                            0x200AE
#define HIDD_LVHEADER                           0x200B0
#define HIDD_TVHEADER                           0x200B1
#define HIDD_PPTRACKTAGS                        0x200C9
#define HIDD_PPTRACKS                           0x200C9
#define HIDD_PPOPTIONSMAIN                      0x200CB
#define HIDD_PPVARIOUS                          0x200CD
#define HIDD_PPARTISTSMAIN                      0x200CE
#define HIDD_PPARTISTS                          0x200CE
#define HIDD_PPPICTURE                          0x200D0
#define HIDD_PPINFO                             0x200D1
#define HIDD_PPALBUMS                           0x200D2
#define HIDD_PPMULTIPLETRACKS                   0x200D7
#define HIDD_TOOLBAR                            0x200D9
#define HIDD_PPBESTWORSE                        0x200E7
#define HIDD_PPRATINGSEARCH                     0x200E7
#define HIDD_PROPPAGE_SMALL                     0x200E8
#define HIDD_PPSPECIALINFO                      0x200E8
#define HIDD_DIALOG1                            0x200E9
#define HIDD_INFOQUERY                          0x200F6
#define HIDD_DIALOG2                            0x200F7
#define HIDD_PPINTERNETOPTIONS                  0x200F8
#define HIDD_PPPLAYEROPTIONS                    0x200F9
#define HIDD_PPFULLTEXT                         0x200FB
#define HIDD_DIALOG3                            0x200FF
#define HIDD_MINIPLAYER                         0x200FF
#define HIDD_PPTREEVIEWOPTIONS                  0x20106
#define HIDD_PPTAGGING                          0x20107
#define HIDD_EMPTYDB                            0x2010A
#define HIDD_MESSAGE                            0x2010A
#define HIDD_LIST_TOOLTIP                       0x2010B
#define HIDD_QUIZ                               0x2015F
#define HIDD_INPUTBOX                           0x20162
#define HIDD_PPDETAILEDSEARCH                   0x2016B
#define HIDD_DRIVES                             0x2016F
#define HIDD_VISVIEW                            0x20170
#define HIDD_PLAYERVIEW                         0x20170
#define HIDD_SERIALIZETRACKS                    0x20183
#define HIDD_PANE                               0x201AA
#define HIDD_PPCOLORS                           0x201AF
#define HIDD_PPMINIPLAYER                       0x201EE
#define HIDD_PPLANGUAGES                        0x201EF
#define HIDD_PPSKINS                            0x201F0
#define HIDD_PPGLOBALHOTKEYS                    0x201FF
#define HIDD_RENAMER                            0x20200
#define HIDD_TAGSFROMFILENAME                   0x20201
#define HIDD_PPGENERIC                          0x20203
#define HIDD_PPINFOCONTROL                      0x20204
#define HIDD_LASTFM                             0x20208
#define HIDD_USERPROGRESS                       0x20209
#define HIDD_ADD_NETFOLDER                      0x28019
#define HIDD_REFRESH_QUICK                      0x2801C
#define HIDD_REFRESH_2SIDE                      0x2801D
#define HIDD_REFRESH_REREAD                     0x2801E
