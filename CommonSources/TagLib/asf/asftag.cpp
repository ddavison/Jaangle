...
ASF::Tag::track() const
{
	...
	{
		TagLib::ASF::Attribute& tag = d->attributeListMap["WM/TrackNumber"][0];
		switch (tag.type())
		{
		...
		case TagLib::ASF::Attribute::WordType:
			return (int)tag.toUInt();
			break;
		}
	}
	if(d->attributeListMap.contains("WM/Track"))
		return d->attributeListMap["WM/Track"][0].toString().toInt();//=== Alex - Change (It is string by default)
	//=== ALEX END
	return 0;
}
