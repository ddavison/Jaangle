...
namespace TagLib {
  ...
  public:
	...
	//=== Lyrics
	virtual String lyrics_AL() const					{return String::null;}
	virtual void setLyrics_AL(const String &s)			{}
	//=== Rating
	virtual uint rating_AL() const						{return 0;}
	virtual void setRating_AL(uint i)					{}
	//=== Picture
	virtual bool picture_AL(String& mime, ByteVector& data, String& description) const	{return false;}
	virtual void setPicture_AL(String& mime, ByteVector& data, String& description)		{}
	//=== Album Artist
	virtual String albumArtist_AL() const				{return String::null;}
	virtual void setAlbumArtist_AL(const String &s)		{}
	//=== Composer
	virtual String composer_AL() const					{return String::null;}
