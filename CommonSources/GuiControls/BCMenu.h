...
public:
	...
	BOOL AppendMenuA(UINT nFlags,UINT nIDNewItem,const char *lpszNewItem,HICON hIcon);
	...
	BOOL AppendMenuW(UINT nFlags,UINT nIDNewItem,wchar_t *lpszNewItem, HICON hIcon);
	...
	void SetFont(CFont* pFont)	{m_pExternalFont = pFont;}
	CFont* GetFont();
...
protected:
	...
	BOOL m_bDynIcons;
	BOOL m_loadmenu;
	CFont* m_pExternalFont;
	CFont* m_pInternalFont;
