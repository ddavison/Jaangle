...
// 	*
//	*/ 
#ifndef _IniAppSettings_h_
#define _IniAppSettings_h_

#include "AppSettings.h"

class IniAppSettings: public AppSettings
{
public:
	IniAppSettings();
	IniAppSettings(LPCTSTR connectionString);
	virtual ~IniAppSettings();
	...
	virtual BOOL Read(LPCTSTR category, LPCTSTR setting, std::basic_string<TCHAR>& value, LPCTSTR defaultVal);
