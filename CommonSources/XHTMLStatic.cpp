...
//=============================================================================
{
	...
	if (m_bRefresh)
	{
		...
		{
			m_hBackgroundDC = CreateCompatibleDC(hDC);
			m_hBackgroundBitmap = CreateCompatibleBitmap(hDC, nRectWidth, nRectHeight);
			HBITMAP oldBitmap = (HBITMAP) SelectObject(m_hBackgroundDC, m_hBackgroundBitmap);
			BitBlt(m_hBackgroundDC, 0, 0, nRectWidth, nRectHeight, hDC, 0, 0, SRCCOPY);
			//SelectObject(m_hBackgroundDC, oldBitmap);
		}

		// copy background from parent
		BitBlt(m_hMemDC, 0, 0, nRectWidth, nRectHeight, m_hBackgroundDC, 0, 0, SRCCOPY);
