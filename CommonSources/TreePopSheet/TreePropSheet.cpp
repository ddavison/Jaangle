...
BOOL CTreePropSheet::OnInitDialog() 
{
	...
	const DWORD	dwTreeStyle = TVS_SHOWSELALWAYS|TVS_TRACKSELECT|TVS_HASLINES|TVS_LINESATROOT|TVS_HASBUTTONS|TVS_FULLROWSELECT;
	...
	#if _MFC_VER >= 0x0700
	{
		...
		m_pwndPageTree->SetWindowPos(NULL,0,0,0,0,
